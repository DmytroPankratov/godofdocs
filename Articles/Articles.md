...
**Пример**: В [Django tutorial](https://docs.divio.com/tutorials/) ученикам обещают рабочее веб-приложение на Django с Postgres и S3. Успех зависит от того, насколько четко и пошагово соблюдены инструкции.
...
[Читать статью на Nuancesprog](https://nuancesprog.ru/p/10971/)
